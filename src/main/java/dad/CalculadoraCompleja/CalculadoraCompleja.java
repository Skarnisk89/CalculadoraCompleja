...
public class CalculadoraCompleja extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Ope.setPadding(new Insets(5)); //sirve para separar verticalmente las cosas que tengas alrededor
		...
		separador.setOrientation(Orientation.HORIZONTAL); //separacion de linea
